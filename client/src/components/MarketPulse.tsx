  ...
  return (
    <section className="w-full rounded-3xl border border-slate-800/70 bg-gradient-to-b from-slate-950 via-slate-950/80 to-slate-950/40 p-6 shadow-[0_35px_120px_rgba(2,6,23,0.65)]">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-slate-500">Market Pulse</p>
          <h2 className="mt-2 text-2xl font-semibold text-white tracking-tight">Realtime view of the macro tape</h2>
      ...
      <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-3 rounded-2xl border border-slate-800/70 bg-slate-950/60 p-4 shadow-inner shadow-black/20 sm:flex-row sm:items-center">
        <div className="flex-1">
          <label className="text-[11px] uppercase tracking-[0.3em] text-slate-500">Add ticker</label>
          <input
      ...
      <div className="mt-4 flex flex-wrap items-center gap-2 text-xs text-slate-400">
        <span className="text-[11px] uppercase tracking-[0.3em] text-slate-500">Quick add</span>
